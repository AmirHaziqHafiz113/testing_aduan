                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12" style="text-align: right;">
                                    <a class='btn btn-success' onclick='modDisp("service");' style='color:white'>Add
                                        Service</a>
                                </div>
                            </div>
                            <br>
                                        ...
                                        if ($result) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                if (isset($_GET['del'])) {
                                                    ...
                                                    if ($run_delete === true) {
                                                        echo "<script>alert('record deleted succesfully'); window.open('service.php','_self');</script>";
                                                    } else {
                                                ...
                                                echo "<td><center>
                                                                <a class='btn btn-danger' href='service.php?del=" . $row['Service_ID'] . "'>Delete</a>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
